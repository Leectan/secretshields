 ...
 *
 * IMPORTANT: This is a masking assistant only.
 * It does NOT forward to Cursor/Copilot providers.
 * It does NOT intercept or modify other chat systems' messages.
 *
 * Prerequisites before implementation:
 * 1. Verify Chat Participants API is stable in target vscode.d.ts baseline
 * 2. Bump engines.vscode to required minimum
 * 3. Add "contributes.chatParticipants" to package.json
