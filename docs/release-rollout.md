...
Operational checklist for launching a SecretShields release. Version must match `package.json`.
...
> **SecretShields** is a local-first VS Code/Cursor extension that automatically masks secrets when you copy them, so you never accidentally paste API keys or tokens into AI chats, terminals, or pastebins.
>
...
Pause rollout and investigate if any of these occur:
...
| -------------------------- | -------- | ---------------------------------------- |
| Launch period (week 1-2)   | 2 weeks  | Patch on demand (daily if needed)        |
| Stabilization (week 3-4)   | 2 weeks  | Weekly patch batches                     |
| Ongoing releases (week 5+) | Ongoing  | Biweekly patches, monthly minor releases |
...
5. Execute `docs/release-checklist.md` in VS Code + Cursor
